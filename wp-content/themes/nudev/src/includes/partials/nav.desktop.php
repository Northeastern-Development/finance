...
<nav class="nu__main-nav" id="nu__main-nav-desktop">
    <ul>
        ...
        <li><a target="_blank" title="View the Banner Codes Page [will open in a new tab or window]" aria-label="View the Banner Codes Page [will open in a new tab or window]" href="https://prod-web.neu.edu/wasapp/Banner/Finance/secure/searchAccount.do?q=AccountCode"><span>Banner Codes</span></a></li>
        <?php 
            // Nav Refactor :
