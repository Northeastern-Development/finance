...
<nav class="nu__main-nav" id="nu__main-nav-desktop">
    <ul>
        ...
        <?php 
         ...
         ?>
        <li class="<?php echo $if_active; ?>"><a title="Click to open the Forms Page" href="<?php echo get_permalink( get_page_by_path('forms') ); ?>"><span>Forms</span></a></li>
        <?php 
         ...
         ?>
        <li class="<?php echo $if_active; ?>"><a title="Click to open the Tools Page" href="<?php echo get_permalink( get_page_by_path('tools') ); ?>"><span>Tools</span></a></li>
        ...
        <li class="has-children <?php echo $if_active; ?>" data-id="about"><a href=""><span>About</span></a>
            <div class="neumenu-wrapper" id="about">
                <div class="neumenu-wrapper-inner">
                    <a title="Click to view the about page" href="<?php echo get_permalink( get_page_by_path('about') ); ?>">Departments and Staff</a>
                    <a title="Click to view the contact page" href="<?php echo get_permalink( get_page_by_path('contact') ); ?>">Contact Us</a>
                </div>
            </div>
        </li>
