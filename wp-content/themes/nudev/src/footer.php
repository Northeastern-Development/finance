            ...
            <div id="sitefooter">
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li title="Northeastern University Finance Division">
                            <a href="<?=home_url()?>" title="Click to return to the Home Page" aria-label="Click to return to the Home Page">
                        ...
                        <li>
                            <h5>Quick Links</h5>
                            <ul>
                                <li><a title="View the NU Policies Page [will open in a new tab or window]" aria-label="View the NU Policies Page [will open in a new tab or window]" target="_blank" href="https://www.northeastern.edu/policies">Policies</a></li>
                                <li><a title="View the News and Updates Page" aria-label="View the News and Updates Page" href="<?php echo get_permalink(143); ?>">News and Updates</a></li>
                                <li><a title="View the Employee Discounts Page" aria-label="View the Employee Discounts Page" href="<?php echo get_permalink(3239); ?>">Employee Discounts</a></li>
                                <li><a title="View the Financial Statements Page" aria-label="View the Financial Statements Page" href="<?php echo get_permalink(3167); ?>">Financial Statements</a></li>
                                <li><a title="View the Glossary Page" aria-label="View the Glossary Page" href="<?php echo get_permalink(3103); ?>">Glossary</a></li>
                                <li><a title="View the Contact Us Page" aria-label="View the Contact Us Page" href="<?php echo get_permalink(3259); ?>">Contact</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="https://www.northeastern.edu/hrm/resources/hr-payroll/" title="View Human Resources / Payroll [will open in a new tab or window]" aria-label="View Human Resources / Payroll [will open in a new tab or window]" target="_blank">Human Resources / Payroll</a></li>
                                <li><a href="https://studentfinance.northeastern.edu/" title="View Student Financial Services [will open in a new tab or window]" aria-label="View Student Financial Services [will open in a new tab or window]" target="_blank">Student Financial Services</a></li>
                                <li><a href="http://www.northeastern.edu/research/raf/" title="View Research Enterprise Services [will open in a new tab or window]" aria-label="View Research Enterprise Services [will open in a new tab or window]" target="_blank">Research Enterprise Services</a></li>
                            </ul>
                        </li>
